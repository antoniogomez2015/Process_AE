...
{
xml = me.XML;
editWin = (thisObj instanceof Panel)?thisObj:new Window("palette","Edit the ft-Toolbar",undefined,{resizeable:false});
res = ((("group { orientation:'column', alignment:['fill','fill'], alignChildren:['fill','fill'], margins:0,  \n\t\t\t\t\t\t\t\t\t\t\t\t registred: StaticText { text:'ft-Toolbar v." + me.version) + "        ") + ftToolbar_registration) + "', preferredSize: [300,20]}, \n\t\t\t\t\t\t\t\t\t\t\t\t  buttons: Panel{text:'Buttons Settings', orientation:'row', alignment:['fill','fill'], alignChildren:['center','center'], margins: 10, spacing: 0,\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpList: Group{orientation:'column', alignment:['fill','fill'], alignChildren:['center','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t   gpCtr: Group{orientation:'row', alignment:['left','top'], margins: 0, alignChildren:['center','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t addBtn: Button{ text: 'Add',preferredSize: [50,20], helpTip:'Add Button'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t deleteBtn: Button{ text: 'Delete', preferredSize: [50,20], helpTip:'Delete Selected Button'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t upBtn: Button{ text: 'Up' , preferredSize: [50,20], helpTip:'Move Button Up'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t downBtn: Button{ text: 'Down', preferredSize: [50,20], helpTip:'Move Button Down'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t   list: ListBox { alignment:['left','top'], preferredSize: [225,335], helpTip:'List of all the buttons'} , \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpParam: Group{orientation:'column', alignment:['fill','fill'], margins: 20, alignChildren:['left','top'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  gpName: Group{orientation:'row', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'Name: ', preferredSize: [50,15]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tval: EditText { properties:{multiline:false}, preferredSize:[150,20], helpTip:'Name which will be on the button (Note it might be crop if it si longer than the Button size)'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  gpTip: Group{orientation:'row', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'HelpTip: ', preferredSize: [50,15]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tval: EditText { properties:{multiline:false}, preferredSize:[150,20], helpTip:'Help Tip which will be shown when the mouse is over the button (longer name ?)' }, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t gpIcon: Group{orientation:'row', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'Icon: ', preferredSize: [50,15]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tval: EditText { properties:{multiline:false}, preferredSize:[100,20], helpTip:'Icon file path' }, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtn: Button { text:'Browse', preferredSize:[60,20], helpTip:'Load icon file' },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t gpType: Group{orientation:'row', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t lbl: StaticText { text:'Type: ', alignment:['fill','center'], preferredSize: [50,15]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t val: DropDownList { alignment:['fill','center'], properties:{items:['EFFECT','ANIMATION PRESET','SCRIPT LAUNCHER','MENU','JAVASCRIPT','OS']}, preferredSize:[150,20], helpTip:'Select the Type of Button : \\nEFFECT -> apply an Effect on the selected layer \\nANIMATION PRESET -> apply *Animation Presets \\nSCRIPT LAUNCHER -> Launch a .js, .jsx, .jsxbin script file\\nMENU -> call a command found in one of AEs menu \\nOS -> execute a shell/terminal operating system command \\nJAVASCRIPT -> execute some AE related javascript'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t gpCommand: Group{orientation:'column', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'Command: ', preferredSize: [70,15]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tval: EditText { properties:{multiline:true}, align:[fill,fill],preferredSize: [250,170], helpTip:'Effect name or Matchname (recommended). \\nFor example : Levels'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpHelpBtn: Group{orientation:'stack', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmatchNameBtn: Button{ text: 'Get Effect Name',preferredSize: [150,20], helpTip:'will return the Matchname (unique name) of the effect \\n-Add effect to any layer \\n-Select the effect name in the effect control panel \\n-Click this button to get the matchname'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tscriptBtn: Button{ text: 'Browse Scripts',preferredSize: [150,20], helpTip:'Load a Script file (.js, .jsx, .jsxbin)'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tpresetBtn: Button{ text: 'Browse Animation Presets',preferredSize: [150,20], helpTip:'Load an Animation preset file (.ffx)'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpJsBtn : Group{orientation:'row', alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjsCodeBtn: Button{ text: 'Script Examples',preferredSize: [125,20], helpTip:'Find scripts shared by users'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tjsdocBtn: Button{ text: 'Scripting Help',preferredSize: [125,20], helpTip:'Adobe After Effects Scripting Guide'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t  },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpValid: Group{orientation:'column', alignment:['fill','fill'], alignChildren:['right','top'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tokBtn: Button{ text: 'Ok',preferredSize: [60,20], helpTip:'will save the new config on your harddrive'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tcancelBtn: Button{ text: 'Cancel',preferredSize: [60,20], helpTip:'will restore the old configuration'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\timportBtn: Button{ text: 'Import',preferredSize: [60,20], helpTip:'import an existing config file'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\texportBtn: Button{ text: 'Export',preferredSize: [60,20], helpTip:'export the config to an xml'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\taboutBtn: Button{ text: 'About',preferredSize: [60,20], helpTip:'About/Help'},\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t },\n\t\t\t\t\t\t\t\t\t\t\t\t\t}, \n\t\t\t\t\t\t\t\t\t\t\t\t\tgenerals: Panel{ text:'General Settings', orientation:'column', alignment:['fill','top'], alignChildren:['center','center'], margins: 10, spacing: 0,\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t gpBtnSize: Group{orientation:'row', alignment:['left','top'], alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'Buttons size: ', preferredSize: [90,20]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth: EditText { properties:{multiline:false},preferredSize: [25,20], helpTip:'width'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\theight: EditText { properties:{multiline:false},preferredSize: [25,20], helpTip:'height'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tgpXMLPath: Group{orientation:'row', alignment:['left','top'], alignChildren:['left','center'],\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tlbl: StaticText { text:'Config File Path: ', preferredSize: [90,20]}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tval: EditText { properties:{multiline:false},preferredSize: [425,20], helpTip:'Path to XML file'}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tbtn: Button { text:'Browse', preferredSize:[60,20] },\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t}, \n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\t\t\t\t\t}";
 ...
 */
ftToolbar_registration = "Registered to: Monter  - Pro Site License" //+ ftToolbar_trial_serialization("parseReg");
if(doRun)
{
